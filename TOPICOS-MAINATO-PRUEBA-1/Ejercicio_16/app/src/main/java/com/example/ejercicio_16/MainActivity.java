...
public class MainActivity extends AppCompatActivity {
    ...
    public void consultaporDescripcion(View v) {
        ...
        if (fila.moveToFirst()) {
            ...
            Toast.makeText(this, "No existe un articulo con ese descripcion", Toast.LENGTH_SHORT).show();
        bd.close();
    }
    ...
    public void bajaporcodigo(View v) {
        ...
        et3.setText("");
        if (cant == 1) {
            Toast.makeText(this, "Se borro el articulo con su codigo", Toast.LENGTH_SHORT).show();
        } else
            Toast.makeText(this, "No existe un articulo con ese codigo", Toast.LENGTH_SHORT).show();
        bd.close();
    }
    ...
    public void modificacion(View v) {
        ...
        ContentValues registro = new ContentValues();
        registro.put("codigo", cod);
        registro.put("descipcion", descri);
        registro.put("precio", pre);
        int cant = bd.update("articulos", registro, "codigo=" + cod, null);
        bd.close();
        if (cant == 1) {
            Toast.makeText(this, "Se modificaron os datos", Toast.LENGTH_SHORT).show();
        } else
            Toast.makeText(this, "No existe un articulo con ese codigo", Toast.LENGTH_SHORT).show();
        bd.close();
